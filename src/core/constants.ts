...
// DOM Class Names
export const TAB_HEADER_CLASS =
  "tab-header style-scope ytmusic-player-page" as const;
export const TAB_CONTENT_CLASS =
  "tab-content style-scope tp-yt-paper-tab" as const;
export const LYRICS_CLASS = "blyrics-container" as const;
export const CURRENT_LYRICS_CLASS = "blyrics--active" as const;
export const ZERO_DURATION_ANIMATION_CLASS =
  "blyrics-zero-dur-animate" as const;
...
export const FONT_LINK =
  "https://api.fontshare.com/v2/css?f[]=satoshi@1&display=swap" as const;
...
export const BINIMUM_LYRICS_API_URL =
  "https://lyrics-api.binimum.org/" as const;
...
export const LEGATO_API_URL =
  "https://lyrics-api.boidu.dev/kugou/getLyrics" as const;
export const LRCLIB_UPLOAD_URL = "https://lrclibup.boidu.dev/" as const;
export const LRCLIB_CLIENT_HEADER =
  "BetterLyrics Extension (https://github.com/better-lyrics/better-lyrics)" as const;
export const THEME_STORE_API_URL =
  "https://better-lyrics-themes-api.boidu.dev" as const;
export const THEME_STORE_TURNSTILE_URL =
  `${THEME_STORE_API_URL}/turnstile` as const;
const THEME_REGISTRY_BASE =
  "https://raw.githubusercontent.com/better-lyrics/themes" as const;
export const THEME_REGISTRY_URL = `${THEME_REGISTRY_BASE}/master` as const;
export const TRANSLATE_LYRICS_URL = function (
  lang: string,
  text: string,
): string {
  return `https://translate.googleapis.com/translate_a/single?client=gtx&sl=auto&tl=${lang}&dt=t&q=${encodeURIComponent(text)}`;
};
export const TRANSLATE_IN_ROMAJI = function (
  lang: string,
  text: string,
): string {
...
export const CUBEY_LYRICS_API_URL_TURNSTILE =
  "https://lyrics.api.dacubeking.com/" as const;

export const CUBEY_LYRICS_API_URL =
  "https://lyrics.api.dacubeking.com/" as const;
...
export const LYRICS_FOUND_LOG =
  "[BetterLyrics] Lyrics found, injecting into the page" as const;
export const NO_LYRICS_FOUND_LOG =
  "[BetterLyrics] No lyrics found for the current song" as const;
export const LRCLIB_LYRICS_FOUND_LOG =
  "[BetterLyrics] Lyrics found from LRCLIB" as const;
export const PROVIDER_SWITCHED_LOG =
  "[BetterLyrics] Switching to provider = " as const;

// UI State Logs
export const LYRICS_TAB_HIDDEN_LOG =
  "[BetterLyrics] (Safe to ignore) Lyrics tab is hidden, skipping lyrics fetch" as const;
export const LYRICS_TAB_CLICKED_LOG =
  "[BetterLyrics] Lyrics tab clicked, fetching lyrics" as const;
...
export const LYRICS_WRAPPER_CREATED_LOG =
  "[BetterLyrics] Lyrics wrapper created" as const;
...
export const SONG_SWITCHED_LOG =
  "[BetterLyrics] Song has been switched" as const;
export const LOADER_TRANSITION_ENDED =
  "[BetterLyrics] Loader Transition Ended" as const;
export const LOADER_ANIMATION_END_FAILED =
  "[BetterLyrics] Loader Animation Didn't End" as const;
export const PAUSING_LYRICS_SCROLL_LOG =
  "[BetterLyrics] Pausing Lyrics Autoscroll Due to User Scroll" as const;

// Feature State Logs
export const AUTO_SWITCH_ENABLED_LOG =
  "[BetterLyrics] Auto switch enabled, switching to lyrics tab" as const;
export const TRANSLATION_ENABLED_LOG =
  "[BetterLyrics] Translation enabled, translating lyrics. Language: " as const;
export const TRANSLATION_ERROR_LOG =
  "[BetterLyrics] Unable to translate lyrics due to error" as const;
...
export const STORAGE_TRANSIENT_SET_LOG =
  "[BetterLyrics] Set transient storage for key: " as const;
export const NO_LYRICS_ELEMENT_LOG =
  "[BetterLyrics] No lyrics element found on the page, skipping lyrics injection" as const;
export const LYRICS_CHECK_INTERVAL_ERROR =
  "[BetterLyrics] Error in lyrics check interval:" as const;
